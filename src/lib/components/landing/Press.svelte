...
<section id="press" class="border-b border-border/60 py-14 sm:py-16">
	<div class="mx-auto max-w-6xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl text-center">
			<h2 class="text-base/7 font-semibold text-lime-500">Press &amp; media</h2>
			<p class="mt-2 text-pretty text-4xl font-semibold tracking-tight sm:text-5xl">
				Books, talks, and write-ups
			</p>
		</div>
		...
		{#if book}
			<a
				...
				target="_blank"
				rel="noreferrer"
				class="group mt-8 flex flex-col gap-5 rounded-2xl border border-border bg-card p-6 transition-colors duration-200 hover:border-lime-500/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lime-500 sm:flex-row sm:items-center sm:p-7"
			>
				<span
