...
{#if next}
	...
	>
		...
		>
			<Calendar class="h-4 w-4 shrink-0 text-lime-500" aria-hidden="true" />
			...
			<ArrowRight
				class="h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-lime-500"
				aria-hidden="true"
			/>
		</div>
	</a>
