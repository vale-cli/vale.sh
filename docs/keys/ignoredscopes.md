...
By default, Vale ignores `tt`, `code`, `kbd`, and `samp` tags. Setting this key **replaces** that list rather than adding to it, so include the defaults you still want. For example, considering the following Markdown file:
