...
## [Structure and hosting](packages.md#structure-and-hosting)
...
The `StylesPath` should be named “styles” and can contain any typically-supported subfolder—such as [styles](../topics/styles.md) and [vocabularies](vocabularies.md). The `.vale.ini` file should reference the included `StylesPath`:
