...
`ls-config`, `ls-dirs`, and `ls-vars` print JSON instead of a table under `--output=JSON`.
...
| `--ext`           | <p>The format to read stdin as, by file extension.<br><code>$ echo "*This* is Markdown" &#124; vale --ext=.md</code></p>                                                                                                                       |
