...
* [StylesPath](keys/stylespath.md)
* [Packages](keys/packages.md)
* [Vocabularies](keys/vocabularies.md)
* [MinAlertLevel](keys/minalertlevel.md)
* [IgnoredScopes](keys/ignoredscopes.md)
* [IgnoredClasses](keys/ignoredclasses.md)
* [SkippedScopes](keys/skippedscopes.md)
* [BasedOnStyles](keys/basedonstyles.md)
* [BlockIgnores](keys/blockignores.md)
...
* [existence](checks/existence.md)
* [substitution](checks/substitution.md)
* [occurrence](checks/occurrence.md)
* [repetition](checks/repetition.md)
* [consistency](checks/consistency.md)
...
* [VS Code](https://marketplace.visualstudio.com/items?itemName=ChrisChinchilla.vale-vscode)
* [Neovim](https://github.com/neovim/nvim-lspconfig)
* [Vim and Neovim (ALE)](https://github.com/dense-analysis/ale)
...
* [Reviewdog](topics/templates.md#creating-a-rdjsonl-template)
* [GitHub code scanning](topics/templates.md#creating-a-sarif-template)
* [Claude Code](guides/agents.md#claude-code)
* [Mintlify](https://www.mintlify.com/docs/deploy/ci)
* [Promptless](https://promptless.ai/docs/for-docs/audit/standards-enforcement/)
